...
CREATE TABLE users (
    ...
    has_car VARCHAR(3) DEFAULT 'NO',  -- as well as addresss coords
    ...
    address_latitude DECIMAL(9,6) NOT NULL,-- SALLY NEEDS --
    address_longitude DECIMAL(9,6) NOT NULL,-- SALLY NEEDS --
    number_of_match INT DEFAULT 0,
    is_matched VARCHAR(3) DEFAULT 'NO'
);
...
INSERT INTO users (
    ...
    creation_timestamp, 
    update_timestamp,
    address_latitude,-- SALLY NEEDS --
    address_longitude,-- SALLY NEEDS --
    number_of_match,
    is_matched
) 
VALUES (
...
CREATE TABLE matching_data (
    ...
    user_id_person1 INT,
    user_id_person2 INT,
    google_actual_distance1 DECIMAL(10,2) NOT NULL, -- Distance from Google Maps API (in km or miles)
    google_actual_distance2 DECIMAL(10,2) NOT NULL, -- Distance from Google Maps API (in km or miles)
    ...
    destination_arrival_diff DECIMAL(4,1),
    destination_departure_diff DECIMAL(4,1),
    ...
    match_quality FLOAT(5,2), -- some metric to record quality of match, decide sort in website
